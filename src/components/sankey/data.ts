...
export const SE_LINKS: SELinkDef[] = [
  ...
  { source: 'revenue', target: 'cfo', type: 'persona', hoverContent: 'TechFlow-N4AE.revenue.total' },
  { source: 'revenue', target: 'cro', type: 'persona', hoverContent: 'TechFlow-N4AE.revenue.arr \u00b7 TechEdge-25KH.revenue.services' },
  { source: 'cogs', target: 'cfo', type: 'persona', hoverContent: 'TechFlow-N4AE.cogs.direct \u00b7 TechEdge-25KH.cogs.labor' },
  { source: 'opex', target: 'cfo', type: 'persona', hoverContent: 'TechFlow-N4AE.opex.sga \u00b7 TechEdge-25KH.opex.facilities' },
  { source: 'opex', target: 'coo', type: 'persona', hoverContent: 'TechFlow-N4AE.opex.operations \u00b7 TechEdge-25KH.opex.logistics' },
  { source: 'cash_flow', target: 'cfo', type: 'persona', hoverContent: 'TechFlow-N4AE.cash_flow.operating \u00b7 TechEdge-25KH.cash_flow.investing' },
  { source: 'asset', target: 'cfo', type: 'persona', hoverContent: 'TechFlow-N4AE.asset.current \u00b7 TechEdge-25KH.asset.fixed' },
  { source: 'chart_of_accounts', target: 'cfo', type: 'persona', hoverContent: 'TechFlow-N4AE.coa.gl_structure' },
  { source: 'employee', target: 'chro', type: 'persona', hoverContent: 'TechFlow-N4AE.employee.headcount \u00b7 TechEdge-25KH.employee.attrition' },
  { source: 'employee', target: 'coo', type: 'persona', hoverContent: 'TechFlow-N4AE.employee.utilization' },
  { source: 'customer', target: 'cro', type: 'persona', hoverContent: 'TechFlow-N4AE.customer.arr \u00b7 TechEdge-25KH.customer.churn' },
  { source: 'customer', target: 'cto', type: 'persona', hoverContent: 'TechEdge-25KH.customer.platform_usage' },
  { source: 'vendor', target: 'coo', type: 'persona', hoverContent: 'TechFlow-N4AE.vendor.spend \u00b7 TechEdge-25KH.vendor.contracts' },
  { source: 'vendor', target: 'cto', type: 'persona', hoverContent: 'TechEdge-25KH.vendor.saas_licenses' },
];
